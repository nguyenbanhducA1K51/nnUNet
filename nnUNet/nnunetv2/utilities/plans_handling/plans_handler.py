...
#what is transpose forward and backward
    @property
    ...
    @property
    #purpose of label manager class
    @lru_cache(maxsize=1)
...
if __name__ == '__main__':
    ...
    # 3 is the id of the dataset, which is not here
    print ("path",join(nnUNet_preprocessed, maybe_convert_to_dataset_name(3), 'nnUNetPlans.json'))
