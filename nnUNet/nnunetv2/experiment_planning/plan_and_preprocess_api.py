...
if __name__=="__main__":
    ...
    #  current_module="nnunetv2.experiment_planning"
    # 1 ['/root/repo/liver-tumor-segmentation/nnUNet/nnunetv2'] /root/repo/liver-tumor-segmentation/nnUNet/nnunetv2/experiment_planning
    print ("1",nnunetv2.__path__,join(nnunetv2.__path__[0], "experiment_planning"))
